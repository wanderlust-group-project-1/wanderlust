...
<head>
    ...
    <link href="viewGuide.css" rel="stylesheet">
</head>

<body>
    <div class="view-guidess">
        <div class="frame">
            ...
            <div class="div-1">
                <div class="div-12">
                    <div class="text-wrapper">William Cooray</div>
                    <div class="img-1">
                        <img src="<?php echo ROOT_DIR?>/assets/images/<?php echo ROOT_DIR?>/assets/images/7.png" alt="">
                    </div>
                </div>
                ...
                <form class="div-3">
                    ...
                    <div class="div-4">
                        <div class="div-wrapper">
                            <div class="text-wrapper-2">Places : Nuwara Eliya, Kandy</div>
                        </div>
                        <div class="div-wrapper">
                            <div class="text-wrapper-2">Personality : Calm, Humble</div>
                        </div>
                        <div class="div-wrapper">
                            <div class="text-wrapper-2">Home : Kandy</div>
                        </div>
                    </div>
        ...
        <div class="frame">
            ...
            <div class="CalendarView">
                <img class="image" src="<?php echo ROOT_DIR?>/assets/images/<?php echo ROOT_DIR?>/assets/images/1.png" alt="">
                <button type="submit" id="BookNow" class="small-button-middle"> Book Now </button>
            </div>

            <script>
                document.getElementById("BookNow").addEventListener("click", function () {
                    window.location.href = "GuideBooking.html";
                });
            </script>
        </div>
        ...
        <div class="frame">
            ...
            <div class="sec3-booking">
                <div class="sec3-booking-main">
                    <div class="text-topic">Recent Booking</div>
                    <div class="img-2">
                        <img src="<?php echo ROOT_DIR?>/assets/images/<?php echo ROOT_DIR?>/assets/images/2.png" alt="">
                    </div>
                </div>
