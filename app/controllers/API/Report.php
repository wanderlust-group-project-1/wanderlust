...
?>
    ...
    public function bookingIncome(string $a = '', string $b = '', string $c = ''): void
    {
        // Prepare request and response objects
        $request = new JSONRequest;
        $response = new JSONResponse;
        ...
        $data = [
            'info' => $guide->getGuide($d['id'])[0],
            'income' => $guide->GetMonthlyIncome($d['id'], $d['from'], $d['to'])
        ];
    ...
    public function allRentalIncome(string $a = '', string $b = '', string $c = ''): void
    {
        // Prepare request and response objects
        $request = new JSONRequest;
        $response = new JSONResponse;
        ...
        $data = [
            // 'info' => $rental->getRentalService($d['id'])[0],
            'income' => $rental->GetAllMonthlyIncome($d['from'], $d['to'])
        ];
        ...
        // $address = $data['info']->address;
        // $companyName = "Wanderlust";
        // $reportTitle = "Income by Rental Services Report";
        $reportDate = date("Y-m-d");
        // $userTtile
